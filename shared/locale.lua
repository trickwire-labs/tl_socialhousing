Locale = {
    ['en'] = {
        --Client strings
        --Debug
        updateContextDebug              = 'Updating context for player %d, with house %s, clientside. This was triggered by this client.',
        updateOptionsDebug              = 'Updating house and house seller options for player %d, with house %s, clientside. This was triggered by this client.',
        houseUpdatingSuccessDebug       = 'Successfully updated house and house seller options for player %d with house %s, clientside. This was triggered by this client.',
        ...
        skipUpdatePhysHouseDebug        = 'Player %d does not have a selected social house. Skipping UpdatePhysicalHouse for them. This was triggered by this client.',
        ...
        playerConnectedPedDebug         = 'Player with server ID %d has just connected. Ped model was not checked so far. Checking ped model.',
        ...
        fetchingUpdatingCLDebug         = 'Fetching house and updating clientside selected house for player %d with house %s, serverside.',
        nonExisting                     = 'non-existing',
        fetchingUpdatingCLFail          = 'Failed to fetch house and update clientside selected house for player %d with house %s, serverside. setHouse Callback success is nil.',
        fetchingUpdatingCLSuccess       = 'Successfully fetched house and updated clientside selected house for player %d with house %s, serverside.',
        ...
        invalidPedData                  = 'Invalid data for \"Config.SellerPed", make sure its model string is correct and that every parameter exists. Check the config.lua file.',
        ...
        invalidHouseKey                 = 'Invalid key for house %s, make sure it is shorter than 257 and longer than 0 characters. Check the config.lua file.',
        validHouseKey                   = 'House key %s validated correctly.',
        invalidHouseData                = 'Invalid data for house %s, make sure that every parameter exists, follow the template if in doubt. Check the config.lua file.',
        ...
        invalidIplKey                   = 'Invalid key for ipl %d, make sure it is shorter than 257 and longer than 0 characters. Check the config.lua file.',
        validIplKey                     = 'Ipl key %s validated correctly.',
        invalidIplData                  = 'Invalid data for ipl %s, make sure that every parameter exists, follow the template if in doubt. Check the config.lua file.',
    ...
    ['it'] = {
        ...
        houseUpdatingSuccessDebug       = 'Casa e opzioni del venditore aggiornate con successo per il giocatore %d con casa %s, lato client. Questo è stato triggerato da questo client.',
        ...
        playerConnectedPedDebug         = 'Il giocatore con ID server %d si è appena connesso. Il modello del ped non è stato ancora controllato. Controllo del modello del ped.',
        ...
        fetchingUpdatingCLDebug         = 'Ottenimento della casa e aggiornamento della casa selezionata lato client per il giocatore %d con casa %s, lato server.',
        nonExisting                     = 'inesistente',
        fetchingUpdatingCLFail          = 'Impossibile ottenere la casa e aggiornare la casa selezionata lato client per il giocatore %d con casa %s, lato server. Il callback setHouse ha ritornato nil.',
        fetchingUpdatingCLSuccess       = 'Casa ottenuta e aggiornata con successo lato client per il giocatore %d con casa %s, lato server.',
        ...
        invalidPedData                  = 'Dati non validi per \"Config.SellerPed\", assicurati che la stringa del modello sia corretta e che ogni parametro esista. Controlla il file config.lua.',
        ...
        invalidHouseKey                 = 'Chiave non valida per la casa %s, assicurati che sia più corta di 257 caratteri e più lunga di 0. Controlla il file config.lua.',
        validHouseKey                   = 'Chiave della casa %s validata correttamente.',
        invalidHouseData                = 'Dati non validi per la casa %s, assicurati che ogni parametro esista, segui il template in caso di dubbi. Controlla il file config.lua.',
        ...
        invalidIplKey                   = 'Chiave non valida per IPL %d, assicurati che sia più corta di 257 caratteri e più lunga di 0. Controlla il file config.lua.',
        validIplKey                     = 'Chiave IPL %s validata correttamente.',
        invalidIplData                  = 'Dati non validi per IPL %s, assicurati che ogni parametro esista, segui il template in caso di dubbi. Controlla il file config.lua.',
        validIplData                    = 'Dati IPL per %s validati correttamente.',
        invalidInteractionMethod        = 'Configurazione non corretta per \"Config.InteractionMethod\". Controlla il file config.lua.',
